...
<div class="nav-wrapper">
    <a href="#!" class="brand-logo"><img src="assets/images/LogoHarshal.png"></a>
...
<footer class="webintern-footer">
    <div class="footer-left">
      <div class="footer-text">
        <p>Balance is for average people , if you dream to achieve something extraordinary you need to be obsessed with it 24×7</p>
      </div>
    ...
    <div class="footer-right">
      ...
      <form  action="mailto:prasadrahulprn3@gmail.com"
      method="POST"
